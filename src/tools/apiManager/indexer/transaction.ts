	...
	server.tool(
		...
		"Get transactions related to an account",
		{
			...
			beforeTime: z
				.string()
				.optional()
				.describe("Return transactions before this time (RFC 3339 format)"),
			afterTime: z
				.string()
				.optional()
				.describe("Return transactions after this time (RFC 3339 format)"),
			currencyGreaterThan: z
				.number()
				.int()
				.optional()
				.describe("Return transactions with amount greater than this value"),
			currencyLessThan: z
				.number()
				.int()
				.optional()
				.describe("Return transactions with amount less than this value"),
